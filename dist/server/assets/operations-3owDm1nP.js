...
const SplitErrorComponent = function OperationsError({
  error
}) {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-full p-6 text-center bg-primary-50", children: [
    /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-primary-900 mb-3", children: "Failed to Load Operations" }),
